...
def menu_login():
    ...
    while True:
        ...
        if pilihan == "1":
            ...
            pengguna = linked_list.cari_pengguna(id_karyawan, email_karyawan)
            if pengguna:
                nama_karyawan = pengguna[1]
                print("\n")
                print("+=================================================+")
                print(f" Login berhasil! Selamat datang, {nama_karyawan}  ")
                print("+=================================================+")
                print("\n")
                menu_karyawan()
                break
            ...
            id_manajer = input("Masukkan ID Manajer: ")
            email_manajer = input("Masukkan Email Manajer: ")
            pengguna = linked_list.cari_pengguna(id_manajer, email_manajer)
            if pengguna:
                nama_manajer = pengguna[1]
                print("\n")
                print("+=================================================+")
                print("                --- Login berhasil! ---            ")
                print(f"                Selamat datang, {nama_manajer}    ")
                print("+=================================================+")
                menu_manajer()  
                break  
            else:
